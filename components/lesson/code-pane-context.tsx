 ...
 *
 * 上から 36% ～ 46%。画面の中央より少し上に置いてある。
 * 上端に寄せすぎると、見出しが画面のてっぺんに来た時点で切り替わり、
 * まだ読んでいない話のコードが右に出てしまう。逆に中央まで下げると、
 * 読み始めてからコードが変わるまでが遅く感じる。その間をとった位置。
 *
 * 幅を 10% と狭くしているのは、複数のセクションが同時に該当して
 * コードがチラつくのを防ぐため。
 */
const ACTIVE_BAND = "-36% 0px -54% 0px";
