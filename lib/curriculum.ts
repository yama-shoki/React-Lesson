...
export const curriculum: Part[] = [
  ...
  },
  {
    ...
    summary: "React で作るものは、突き詰めると「関数」と「その引数」でしかない。",
    lessons: [
      {
        slug: "components",
        title: "コンポーネントは関数である",
  ...
  },
  {
    label: "Part 3",
    title: "画面に動きをつける",
    summary: "クリックに反応する、条件で出し分ける、配列を並べる。この 3 つで大半の画面は作れる。",
    lessons: [
      {
        slug: "events",
        title: "イベントハンドラ",
  ...
  },
  {
    label: "Part 4",
    title: "状態 (state)",
    summary: "React でいちばん重要な概念。ここを丁寧にやると、この先が全部つながる。",
    lessons: [
      {
        slug: "usestate",
        title: "useState",
  ...
  },
  {
    label: "Part 7",
    title: "レンダリングの仕組み",
    summary: "「再レンダリング」が実際に何をしているのかを見る。ここから先は目に見えない話が増える。",
    lessons: [
      {
        slug: "rendering",
        title: "再レンダリングとは何か",
  ...
  },
  {
    label: "Part 8",
    title: "パフォーマンス",
    summary: "遅くなってから使う道具たち。先回りして使うと、かえって読みにくくなる。",
    lessons: [
      {
        slug: "memo",
        title: "memo",
...
export const allLessons = curriculum.flatMap((part) =>
  part.lessons.map((lesson) => ({ ...lesson, partLabel: part.label, partTitle: part.title }))
);
