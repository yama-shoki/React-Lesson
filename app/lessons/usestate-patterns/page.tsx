...
const [TOGGLE, SELECTION, SOUP, UNION] = SOURCES.map(
	(source) => source.path,
);
		...
		<LessonShell snippets={snippets}>
			<LessonHeader slug={SLUG}>
				...
				<p>
					...
					<strong>よく出てくる順に 4 つ</strong>並べます。
				</p>
				<p>
					どれも<strong>今日から使うもの</strong>です。
					知っておくと効く応用は、次の章にまとめてあります。
				</p>
			</LessonHeader>
...
const [status, setStatus] = useState<Status>("idle");`}
			...
			<LessonSection id="summary" {...at(TOGGLE, "const [isOpen, setIsOpen]")}>
				...
				<ul>
					...
					<li>
						応用（初期値の遅延評価、<code>key</code> でのリセット）は次の章
					</li>
				</ul>
			</LessonSection>
